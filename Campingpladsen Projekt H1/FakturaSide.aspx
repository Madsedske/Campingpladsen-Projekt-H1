            ...
            <div class="middlecolumn33">
                <div class="card">
                    ...
                    <asp:DetailsView ID="DetailsView1" runat="server" Height="50px" Width="125px" AutoGenerateRows="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" DataSourceID="faktura">
                        ...
                        <Fields>
                            <asp:BoundField DataField="ReservationsNumber" HeaderText="Reservationsnummer" SortExpression="ReservationsNumber" />
                    ...
                    <asp:SqlDataSource ID="faktura" runat="server" ConnectionString="<%$ ConnectionStrings:Reservation %>" SelectCommand="SELECT * FROM [Faktura]"></asp:SqlDataSource>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Reservation %>" SelectCommand="Faktura" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                    <div>
